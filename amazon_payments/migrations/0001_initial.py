...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AmazonPaymentsSession'
        db.create_table(u'amazon_payments_amazonpaymentssession', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('billing_agreement_id', self.gf('django.db.models.fields.TextField')()),
            ('basket', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['basket.Basket'], unique=True, null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['order.Order'], unique=True, null=True, blank=True)),
            ('order_reference_id', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('access_token', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'amazon_payments', ['AmazonPaymentsSession'])

        # Adding model 'AmazonPaymentsTransaction'
        db.create_table(u'amazon_payments_amazonpaymentstransaction', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='transactions', to=orm['amazon_payments.AmazonPaymentsSession'])),
        ...
        db.send_create_signal(u'amazon_payments', ['AmazonPaymentsTransaction'])

        # Adding model 'AmazonPaymentsAuthAttempt'
        db.create_table(u'amazon_payments_amazonpaymentsauthattempt', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('session', self.gf('django.db.models.fields.related.ForeignKey')(related_name='auth_attempts', to=orm['amazon_payments.AmazonPaymentsSession'])),
            ('authorization_id', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('transaction', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['amazon_payments.AmazonPaymentsTransaction'], unique=True, null=True, blank=True)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'amazon_payments', ['AmazonPaymentsAuthAttempt'])


    def backwards(self, orm):
        # Deleting model 'AmazonPaymentsSession'
        db.delete_table(u'amazon_payments_amazonpaymentssession')

        # Deleting model 'AmazonPaymentsTransaction'
        db.delete_table(u'amazon_payments_amazonpaymentstransaction')

        # Deleting model 'AmazonPaymentsAuthAttempt'
        db.delete_table(u'amazon_payments_amazonpaymentsauthattempt')
    ...
    models = {
        ...
        u'amazon_payments.amazonpaymentsauthattempt': {
            'Meta': {'object_name': 'AmazonPaymentsAuthAttempt'},
            'authorization_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'auth_attempts'", 'to': u"orm['amazon_payments.AmazonPaymentsSession']"}),
            'transaction': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['amazon_payments.AmazonPaymentsTransaction']", 'unique': 'True', 'null': 'True', 'blank': 'True'})
        },
        u'amazon_payments.amazonpaymentssession': {
            'Meta': {'object_name': 'AmazonPaymentsSession'},
            'access_token': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'basket': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['basket.Basket']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'billing_agreement_id': ('django.db.models.fields.TextField', [], {}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['order.Order']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'order_reference_id': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'amazon_payments.amazonpaymentstransaction': {
            'Meta': {'object_name': 'AmazonPaymentsTransaction'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'request': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'response': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'session': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'transactions'", 'to': u"orm['amazon_payments.AmazonPaymentsSession']"})
        },
        u'auth.group': {
